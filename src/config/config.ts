...
export const config = {
    ...
    SECRET_ACCESS_KEY: process.env.SECRET_ACCESS_KEY || 'zxc',
    SECRET_REFRESH_KEY: process.env.SECRET_REFRESH_KEY || 'asd',
    SECRET_ACTION_KEY: process.env.SECRET_ACTION_KEY || 'qwerty',
